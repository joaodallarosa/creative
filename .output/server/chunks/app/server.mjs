...
const vueuseHead_1fad13e8 = defineNuxtPlugin((nuxtApp) => {
...
const plugin_5f979bdc = defineNuxtPlugin((nuxtApp) => {
...
const NuxtNestedPage = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$3]]);
const layouts = {};
...
const NuxtPage = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$2]]);
const routes = [
  {
    "name": "index",
    "path": "/",
    "file": "/Users/joao.rosa/fun/p5-showcase/pages/index.vue",
    "children": [],
  ...
  },
  {
    "name": "pieces-piece",
    "path": "/pieces/:piece",
    "file": "/Users/joao.rosa/fun/p5-showcase/pages/pieces/[piece].vue",
    "children": [],
    "component": () => Promise.resolve().then(function() {
      return _piece_;
    })
...
const router_2ec5c2c3 = defineNuxtPlugin((nuxtApp) => {
...
const RootComponent = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$2 = {};
...
const _sfc_main$1 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "container mx-auto bg-gray-300 p-8" }, _attrs))}><h1 class="font-bold text-gray-600 text-lg">Stuff</h1><ul><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(list), (piece) => {
        _push(`<li>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          ...
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button${_scopeId}>${serverRenderer.exports.ssrInterpolate(piece.title)}</button>`);
            } else {
              return [
                vue_cjs_prod.createVNode("button", null, vue_cjs_prod.toDisplayString(piece.title), 1)
              ];
            }
          }),
          _: 2
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button${_scopeId}>Back</button>`);
          } else {
            return [
              vue_cjs_prod.createVNode("button", null, "Back")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<h1>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(title))}</h1><div></div></div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("pages/pieces/[piece].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _piece_ = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": _sfc_main
});
